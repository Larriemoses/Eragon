...
const LOGO_URL =
  "https://res.cloudinary.com/dvl2r3bdw/image/upload/v1752103735/LOGO-ICON-1_gm3k3m.png";
        ...
        <div className="w-full max-w-xs flex justify-between gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col items-start">
              <Link
                to="/contact"
                className="mb-1 text-gray-300 hover:text-green-400 transition"
              >
                Contact Us
              </Link>
              <Link
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col items-start">
              <a
                href="https://wa.me/+2347039729635"
                target="_blank"
              ...
              <a
                href="https://x.com/eragonsnr?s=21/"
                target="_blank"
                rel="noopener noreferrer"
                className="mb-1 text-gray-300 hover:text-green-400 transition"
              >
              ...
              <a
                href="https://facebook.com/ani.okon.5?mibextid=wwXIfr&mibextid=wwXIfr"
                target="_blank"
                rel="noopener noreferrer"
                className="mb-1 text-gray-300 hover:text-green-400 transition"
              >
              ...
              <a
                href="https://instagram.com/eragon_offical"
                target="_blank"
                rel="noopener noreferrer"
                className="mb-1 text-gray-300 hover:text-green-400 transition"
              >

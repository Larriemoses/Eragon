  ...
  <div className="w-[90%] flex flex-col items-center px-4 py-12 bg-white">
    ...
    <div className="flex flex-col md:flex-row items-center justify-center gap-8 max-w-4xl w-full mt-6">
      ...
      <div className="w-full md:w-2/3">
        ...
        <div className="mb-2 font-bold text-gray-800">How It Works</div>
        <ul className="list-disc pl-5 mb-2">
          <li>
            <span className="font-bold text-gray-800">Browse Top Brands</span>
          ...
          <li>
            <span className="font-bold text-gray-800">Get a Verified Code or Link</span>
            <span className="block ml-2  text-gray-800">
              Click to copy a working discount code or use our link to the store.
            </span>
          </li>
          <li>
            <span className="font-bold text-gray-800">Shop or Register Directly</span>
            <span className="block ml-2 text-gray-800">

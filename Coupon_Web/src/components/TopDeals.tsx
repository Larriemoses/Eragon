...
const TopDeals: React.FC = () => {
  ...
  const [loading, setLoading] = useState(false); // Changed default to false to prevent initial "Loading" flash
  ...
  return (
    ...
    // It will be centered using mx-auto for its max-width.
    <div className="py-8 bg-white flex flex-col items-center">
      ...
      {topDealsCoupons.length === 0 ? (
        ...
        // Layout for multiple coupons: responsive grid

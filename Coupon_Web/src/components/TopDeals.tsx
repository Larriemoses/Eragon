      ...
      <div className="w-full flex flex-col items-center gap-8">
        ...
        {topDeals.map(({ product, coupon }) => {
          ...
          return (
            <div
              key={coupon.id}
              // Changed shadow-md to shadow-xl here for a more pronounced border-like shadow
              className="w-full max-w-xl bg-white rounded-2xl shadow-xl p-4 sm:px-6 sm:py-5 flex flex-col gap-2"
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-grow min-w-0">
                  <div className="text-green-700 font-bold text-lg leading-tight break-words">
                    {product.name}
                  </div>
              ...
              {coupon.code && coupon.code.trim() && (
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 mt-4">
                  ...
                  />
                  <button
                    className="bg-green-500 hover:bg-green-600 text-white px-3 py-2 sm:py-1 rounded text-sm transition-colors duration-200 w-full sm:w-auto"
                    onClick={() => {
